...
typedef struct PrompegDecoderConfig {
    int l;
    int d;
    int packet_size;
    int fec_packet_size;
...
typedef struct PrompegDecoder {
    ...
    uint16_t min_discard_old_packet_index;
    uint16_t max_discard_old_packet_index;
    uint16_t min_discard_new_packet_index;
    uint32_t max_discard_new_packet_index;
    int packets_count;
...
PrompegDecoder *ff_prompegdec_alloc_decoder(URLContext *url_context, PrompegDecoderConfig *config);
