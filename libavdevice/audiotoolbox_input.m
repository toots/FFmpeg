...
static const AVOption options[] = {
    ...
    { "recording_buffers", "number of recording buffers in the input queue", offsetof(ATContext, recording_buffers), AV_OPT_TYPE_INT, {.i64=2}, 0, INT_MAX, AV_OPT_FLAG_ENCODING_PARAM },
    { "samples_per_buffer", "size, in samples, of each input buffer in the queue", offsetof(ATContext, samples_per_buffer), AV_OPT_TYPE_INT, {.i64=1024}, 0, INT_MAX, AV_OPT_FLAG_ENCODING_PARAM },
